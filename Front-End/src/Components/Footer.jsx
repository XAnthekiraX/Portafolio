...
export default function Footer({ language }) {
    ...
    return (
        <footer className="flex items-center justify-around w-screen h-auto py-8 text-gray-300 animation">
            <div className="">
                <p className="text-xl">
                    © {currentYear} {language == "esp" ? "Desarrolado por" : "Develop by"} <Link to='/Login'>Anthony Bonilla</Link>
                </p>
            </div>
