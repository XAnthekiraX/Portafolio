  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5">
        ...
        <Card ghost className="flex flex-col items-center justify-center text-center min-h-[320px]">
          <div className="w-14 h-14 rounded-2xl bg-zinc-700/50 border border-zinc-600 flex items-center justify-center mb-3 text-zinc-400">
            <Plus className="w-6 h-6" />
          </div>
          <p className="text-sm font-medium text-zinc-400">
            Agregar proyecto
          </p>
          <p className="text-xs mt-1 max-w-[200px] text-zinc-500">
          ...
          <table className="w-full border-collapse">
            <thead>
              <tr>
                {["Proyecto", "Estado", "Tecnologías", "Visitas", ""].map((h) => (
                  <th
                    key={h}
                    className="text-left font-mono text-[11px] font-medium uppercase tracking-wider text-zinc-400 px-4 py-2.5 border-b border-zinc-700"
                  >
                    {h}
                  </th>
                ))}
            ...
            <tbody>
              {projects.map((p) => (
                ...
                >
                  <td className="px-4 py-3 text-[13px] font-medium text-zinc-100 border-b border-zinc-700">
                    {p.title}
                  </td>
                  ...
                  <td className="px-4 py-3 font-mono text-xs text-zinc-400 border-b border-zinc-700">
                    {p.visits || "—"}
                  </td>
                  <td className="px-4 py-3 border-b border-zinc-700">
                    <Button variant="ghost" className="!p-1">
