      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        >
          ...
          <div className="space-y-4">
            ...
            />
            <div>
              <label htmlFor="edu-type" className="block font-mono text-xs font-medium uppercase tracking-wider text-zinc-400 mb-2">
                Tipo
              </label>
              <select
                id="edu-type"
            ...
            />
            <div>
              <label htmlFor="edu-status" className="block font-mono text-xs font-medium uppercase tracking-wider text-zinc-400 mb-2">
                Estado
              </label>
              <select
                id="edu-status"
